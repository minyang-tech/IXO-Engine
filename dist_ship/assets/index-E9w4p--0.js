...
function getNodeLabel(nodeType, language2, fallback) {
  var _a;
  return ((_a = NODE_TEXT[language2]) == null ? void 0 : _a[nodeType]) || NODE_TEXT.en[nodeType] || fallback || nodeType;
}
    ...
    editable ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "builder-toolbar", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "builder-palette", children: UI_PALETTE.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: getNodeLabel(item.type, language, item.label)
        },
        item.kind
      )) })
    ] }) : null,
...
function EngineEditor() {
  ...
  const [language2, setLanguage] = reactExports.useState("ko");
  ...
  reactExports.useEffect(() => {
    ...
    setDraftLanguage(language2);
    setDraftThemeKey(themeKey);
    setDraftPreviewDevice(previewDevice);
    setDraftTemplateKey("");
  }, [language2, previewDevice, showSettings, themeKey]);
  ...
  const nodesWithTrace = reactExports.useMemo(
    () => nodes.map((node) => {
      ...
      return {
        ...
        data: {
          ...node.data,
          displayLabel: getNodeLabel((_a = node.data) == null ? void 0 : _a.nodeType, language2, (_b = node.data) == null ? void 0 : _b.label),
    ...
    [language2, nodes, runtime.activeNodeIds, runtime.focusedNodeId, runtime.liveValues, runtime.topo]
  );
  ...
  const uiText = UI_TEXT[language2] || UI_TEXT.ko;
  ...
  const searchCandidates = reactExports.useMemo(
    () => Object.values(LIBRARY_TABS).flat().filter((item) => getNodeLabel(item.type, language2, item.label).toLowerCase().includes(searchTerm.toLowerCase())),
    [language2, searchTerm]
  );
  ...
  }, [appendLog, edges, inputValues, language2, nodeCounter, nodes, previewDevice, themeKey, uiElements, viewMode]);
  reactExports.useEffect(() => {
    var _a;
    try {
  ...
  }, [language2, previewDevice, themeKey]);
  ...
  const CanvasPane = /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "editor-area", onDrop, onDragOver, style: { "--trace-duration": `${TRACE_SPEED[speed]}s` }, children: [
    ...
    quickSearchOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "quick-search-overlay", onClick: () => setQuickSearchOpen(false), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "quick-search-card", onClick: (event) => event.stopPropagation(), children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "quick-search-list", children: searchCandidates.slice(0, 8).map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => addNodeFromSearch(item, "center"), children: getNodeLabel(item.type, language2, item.label) }, item.key)) })
    ] }) }) : null
  ] });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: `app-shell lang-${language2}`,
      style: {
              ...
              !collapsed[group] ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "node-list", children: items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    ...
                    getNodeLabel(item.type, language2, item.label)
                  ]
                },
                item.key
              )) }) : null
